...
public class NorthViewPresenter extends AbstractActivity implements Presenter {
	private ClientFactory factory;
	private Place place;

	public NorthViewPresenter(Place place, ClientFactory factory) {
	...
	public void start(AcceptsOneWidget panel, EventBus eventBus) {
		NorthView view = factory.getNorthView();
		/*
