...
public class SouthViewPresenter extends AbstractActivity implements Presenter {
	private ClientFactory factory;
	private Place place;

	public SouthViewPresenter(Place place, ClientFactory factory) {
	...
	public void start(AcceptsOneWidget panel, EventBus eventBus) {
		SouthView view = factory.getSouthView();
		/*
